				...
				<ul id="topMenu" class="nav pull-right">
					...
					<li class="">
                        <?php if( $this->session->userdata( "user" )) { ?>
                            <a onclick="window.location.href='<?php echo base_url() . "user/signout"; ?>'" role="button" style="padding-right:0">
                                <span class="btn btn-large btn-success">Logout</span>
                            </a>
                        <?php } else { ?>
                            <a href="<?php echo base_url(); ?>home/user" role="button" style="padding-right:0">
